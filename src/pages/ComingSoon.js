    ...
    return(
        <div className="w-screen h-screen bg-white ">
            <div>
                ...
                <img className='absolute z-[10] opacity-30 md:opacity-100 md:fixed mix-blend-multiply w-1/3 md:w-1/4 left-0 md:left-[20%] md:top-[10rem] bottom-0' alt='' src={jesus} />
                <img className='fixed bottom-[2rem] right-[3rem] md:right-[10rem] w-[10rem] md:w-[17rem] lg:w-[22rem]' alt='' src={cs} />
            </div>

            <div className="fixed left-[5%] md:left-[43%] top-2 ml-5 mt-[8rem] md:mt-5 mb-10 text-sm md:text-[1rem] rounded-[2rem] rounded-bl rounded-br-[5rem] bg-yellow-500 text-black font-medium w-fit p-7 max-w-[17rem] md:max-w-[20rem] ">
